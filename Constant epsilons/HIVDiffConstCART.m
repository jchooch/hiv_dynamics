%%writefile HIVDiffConstCART.m

function dydt = HIVDiffConstCART(t, y, C)

dydt = [C(1)*y(1)*(1 - (y(1)/C(2))) - C(3)*y(1) - (1 - C(13))*C(4)*y(4)*y(1) - C(5)*y(4)*y(1);  %dT/dt
        (1 - C(13))*C(4)*y(4)*y(1) + C(7)*y(3) - C(8)*y(2);                         %dI/dt
...
%C(10)=c, C(11)=K_L, C(12) = epsilonPI, C(13) = epsilonRTI
