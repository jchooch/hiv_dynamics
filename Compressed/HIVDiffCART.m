...
dydt = [C(1)*y(1)*(1 - (y(1)/C(2))) - C(3)*y(1) - (1 - C(12))*C(4)*y(4)*y(1) - C(5)*y(4)*y(1);  %dT/dt
        (1 - C(12))*C(4)*y(4)*y(1) + C(7)*y(3) - C(8)*y(2);                         %dI/dt
        C(1)*y(3)*(1 - (y(3)/C(11))) + C(5)*y(4)*y(1) - C(6)*y(3) - C(7)*y(3);      %dL/dt
        (1 - C(13))*C(9)*y(2) - C(10)*y(4);     %dVi/dt
        C(13)*C(9)*y(2) - C(10)*y(5)]           %dVni/dt
...
%C(10)=c, C(11)=K_L, C(12) = epsilonRTI, C(13) = epsilonPI
